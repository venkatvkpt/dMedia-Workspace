...
public class FamilyNewsController {
	...
	@RequestMapping(value = "/addFamilyNews", method = RequestMethod.POST)
		...
		if (dao.insertValuesNews(sql,bean)) {
			...
			redirectAttrs
					.addFlashAttribute(
							...
							MessageDispatcher
									.message(
											" Family News Article Submission is Failed,Try Again.",
											false));
		}

		return "redirect:/family.htm";
	}
